/* [pipszi-v2] Ez a fajl a projekt eredeti vendor kodja: bcmath-js + a TCPDF
   PDF417 osztaly JS-portja, valtozatlan algoritmussal.
   Ket apro modositas kellett: (1) ezek a valtozok sloppy modban implicit
   globalkent jottek letre, ESM strict modban viszont ReferenceError lenne
   beloluk, ezert itt modul-szinten deklaraljuk oket; (2) lasd a
   `[pipszi-v2]` jelolest az init()-ben az ecl=0 kezelesenel. */
var sequence, codewords, format, positivePrefix, prefixBaseX, noEmpty, OPTS,
    regexpBody, regexpFlags, optTemp, delim, index;
...
var PDF417 = {
	...
	init: function(code, ecl, aspectratio) {		
		...
		ecl = (ecl === undefined || ecl === null) ? -1 : ecl; // [pipszi-v2] eredetileg `ecl || -1` volt, ami a 0-s szintet is auto-ra valtotta
